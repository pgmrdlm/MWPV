...
/* ============================================================================
   MWPV - 01.15 FRESH CREATE SCRIPT DRAFT

   Purpose:
   - Create a fresh database at schema version 01.15
   ...
   - Fresh install version stamp updated to 01.15
...
SELECT
    ...
    'Fresh database created at version 01.15',
    1
